...
namespace ACPROTO.ACT
{
    ...
    {
        public async Task<Coin> GetCurrencyValue(Coin coin)
        {
        ...
        public decimal TotalPortfolioValue { get; internal set; }
        ...
        public async Task<Ticker> UpdateTickers(Coin coin)
        {
            ...
            try
            {
                var ticker = new Ticker(result, coin.MarketName);
        ...
        public async Task<List<Coin>> GetBalances()
        {
            ...
            foreach (JObject jo in jresult)
            {
                ...
                if (coin == null)
                {
                    ...
                    coin = await GetCurrencyValue(coin);
        ...
        public async Task<Order> SubmitBuyOrder(Coin coin, decimal amount)
        {
        ...
        public async Task<Order> SellAll(Coin coin)
        {
        ...
        public async Task<Order> SubmitSellOrder(Coin coin, decimal amount, decimal price)
        {
            //-coin.TxFee
        ...
        public async Task<Order> SubmitSellOrer(Coin coin, decimal amount, decimal quantity) {
            return new Order();
        }
